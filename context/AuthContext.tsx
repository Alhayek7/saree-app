...
"0598887777": {
  ...
  user: {
    ...
    notificationsEnabled: true,
    savedAddresses: [
      { id: "branch_1", label: "الفرع الرئيسي", address: "الرمال - شارع الوحدة، مجمع الأمل التجاري", icon: "home" },
      { id: "branch_2", label: "فرع الزيتون", address: "الزيتون - دوار أبو حصيرة، بجانب مسجد الفلاح", icon: "briefcase" },
    ],
    walletBalance: 500,
    totalOrders: 145,
    totalRevenue: 2875,
...
"0594000000": {
  ...
  user: {
    id: "support_001",
    fullName: "دعم فني - سريع",
    phone: "0594000000",
    email: "support@saree3.app",
    role: "support",
    neighborhood: "الرمال",
    isActive: true,
    notificationsEnabled: true,
...
//     notificationsEnabled: true,
//     savedAddresses: [
//       { id: "branch_1", label: "الفرع الرئيسي", address: "الزيتون - شارع القدس، بجانب مسجد السلام", icon: "home" },
//     ],
//     walletBalance: 300,
//     totalOrders: 45,
//     totalRevenue: 875,
